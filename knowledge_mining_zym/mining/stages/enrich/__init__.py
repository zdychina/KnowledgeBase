...
from knowledge_mining_zym.mining.contracts.protocols import Enricher, EntityExtractor, RoleClassifier

if TYPE_CHECKING:
    from knowledge_mining_zym.mining.infra.domain_pack import DomainProfile

from knowledge_mining_zym.mining.infra.extractors import (
