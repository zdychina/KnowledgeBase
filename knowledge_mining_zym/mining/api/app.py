...
Start:
    python -m knowledge_mining_zym.mining.api
    # or
    uvicorn knowledge_mining_zym.mining.api.app:create_app --host 0.0.0.0 --port 8901 --factory
"""
...
# Module-level app for `python -m knowledge_mining_zym.mining.api`
app = create_app()
