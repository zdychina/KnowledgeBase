...
VALID_RELATION_TYPES = RST_DB_VALUES | frozenset({
    # Reserved types: not generated by Mining, but accepted by DB schema and
    # consumed by Serving-side GraphExpander / ContextAssembler.
    "previous", "next",
    "same_section", "same_parent_section", "section_header_of",
    "references",
    "elaborates", "condition", "contrast",
    "unrelated", "other",
})
