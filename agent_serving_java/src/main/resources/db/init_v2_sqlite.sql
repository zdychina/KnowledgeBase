-- asset_document_snapshots definition
...
-- asset_retrieval_units_fts definition

CREATE VIRTUAL TABLE asset_retrieval_units_fts
USING fts5(
...
-- asset_retrieval_units_fts_config definition

CREATE TABLE 'asset_retrieval_units_fts_config'(k PRIMARY KEY, v) WITHOUT ROWID;


-- asset_retrieval_units_fts_content definition

CREATE TABLE 'asset_retrieval_units_fts_content'(id INTEGER PRIMARY KEY, c0, c1, c2, c3);


-- asset_retrieval_units_fts_data definition

CREATE TABLE 'asset_retrieval_units_fts_data'(id INTEGER PRIMARY KEY, block BLOB);


-- asset_retrieval_units_fts_docsize definition

CREATE TABLE 'asset_retrieval_units_fts_docsize'(id INTEGER PRIMARY KEY, sz BLOB);


-- asset_retrieval_units_fts_idx definition

CREATE TABLE 'asset_retrieval_units_fts_idx'(segid, term, pgno, PRIMARY KEY(segid, term)) WITHOUT ROWID;


-- asset_source_batches definition
...
-- asset_document_snapshot_links definition
...
-- asset_publish_releases definition
...
-- asset_raw_segments definition

CREATE TABLE asset_raw_segments (
                                    id                  TEXT PRIMARY KEY,
...
-- asset_retrieval_units definition

CREATE TABLE asset_retrieval_units (
                                       id                   TEXT PRIMARY KEY,
                                       document_snapshot_id TEXT NOT NULL REFERENCES asset_document_snapshots(id) ON DELETE CASCADE,
...
-- asset_build_document_snapshots definition
...
-- asset_raw_segment_relations definition

CREATE TABLE asset_raw_segment_relations (
                                             id                  TEXT PRIMARY KEY,
                                             document_snapshot_id TEXT NOT NULL REFERENCES asset_document_snapshots(id) ON DELETE CASCADE,
...
-- asset_retrieval_embeddings definition

CREATE TABLE asset_retrieval_embeddings (
                                            id                 TEXT PRIMARY KEY,
