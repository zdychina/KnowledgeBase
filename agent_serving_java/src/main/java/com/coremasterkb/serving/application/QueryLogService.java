 ...
 * Called exclusively from QueryLogAspect — must never be injected into business code.
 * All failures are swallowed so logging never affects the main response.
 */
public class QueryLogService {
    ...
    public void record(String queryId, SearchRequest request, ContextPack pack, long durationMs) {
        try {
            ...
            if (pack != null) {
                ...
                long seedCount = items.stream().filter(i -> "seed".equals(i.role())).count();
    ...
    private String toJson(Object obj) {
        try {
            return mapper.writeValueAsString(obj != null ? obj : Collections.emptyList());
        } catch (Exception e) {
            return "[]";
        }
    }
