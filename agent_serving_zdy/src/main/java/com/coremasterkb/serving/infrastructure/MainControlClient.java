 ...
 * ({@code GET /api/v1/serving-config}). Serving no longer reads config files directly.
 */
public class MainControlClient {

    private static final Logger log = LoggerFactory.getLogger(MainControlClient.class);
