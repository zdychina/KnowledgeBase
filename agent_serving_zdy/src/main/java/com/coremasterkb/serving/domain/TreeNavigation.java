 ...
 *       search at retrieval time (a clearly dominant chapter with a sufficient sample). When the
 *       signal is weak/spread, this is false and only soft weighting applies — avoiding hard-miss
 *       from a crude rule-based selector.</li>
 * </ul>
 *
 * <p>All prefixes are lower-cased top-level {@code section_path} titles (see
 * {@code TreeNavigator.prefixOf}).</p>
 */
