-- CoreMasterKB Mining Runtime Schema v1.1 - PostgreSQL
--
-- Adapted from 001_mining_runtime.sqlite.sql:
-- - JSON TEXT → JSONB
-- - PRAGMA removed
...
CREATE TABLE IF NOT EXISTS mining_run_stage_events (
    ...
    stage            TEXT NOT NULL CHECK (
        stage IN (
            'parse', 'segment', 'enrich', 'relations', 'discourse',
            'retrieval_units',
            'segment_persist', 'relations_persist', 'retrieval_units_persist',
            'build_relations', 'build_retrieval_units',
